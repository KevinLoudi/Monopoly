...
# from objects_util import position
...
class place(object):
    ...
    def __init__(self, name=None, simple_name=None,types=None, position=None, owner=None, deed=None):
        super(place, self).__init__()
        self.m_sim_name = simple_name
        self.m_name = name
        self.m_type = types
